  ...
  return (
    ...
    <Router>
        <Routes>
          ...
          <Route exact path="/sliver" element={<CardQR name ='silver' dimensions='150x150' materials='acrylic, spray on canvas' price='1800 €'/>} />
          <Route exact path="/green" element={<CardQR name='green' dimensions='150x150' materials='acrylic, spray on canvas' price='1800 €'/>} />
          <Route exact path="/blue" element={<CardQR name='blue' dimensions='150x150' materials='acrylic, spray on canvas' price='1800 €'/>} />
